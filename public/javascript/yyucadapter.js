	...
	if(jQuery.yyucobjnow<jQuery.yyucobjnum){
		...
		if(eval('"undefined" == typeof '+obj)){
			if(obj=='yyuccalendar'){
				...
				// getScript(yyuc_jspath+'kindeditor_new/themes/default/default.css',function(){
				// 	jQuery.yyucobjnow = jQuery.yyucobjnow +1;
				// 	jQuery.loadyyucobj();
				// });
				// getScript(yyuc_jspath+'kindeditor_new/themes/simple/simple.css',function(){
				// 	jQuery.yyucobjnow = jQuery.yyucobjnow +1;
				// 	jQuery.loadyyucobj();
				// });
				getScript(yyuc_jspath+'kindeditor/kindeditor-min.js',function(){
				// getScript(yyuc_jspath+'kindeditor_new/kindeditor.js',function(){
					jQuery.yyucobjnow = jQuery.yyucobjnow +1;
					KindEditor.basePath = yyuc_jspath+'kindeditor/';
					loadkindeditor(inphidden);
					jQuery.loadyyucobj();
				});
				// getScript(yyuc_jspath+'kindeditor_new/lang/zh_CN.js',function(){
				// 	jQuery.yyucobjnow = jQuery.yyucobjnow +1;
				// 	jQuery.loadyyucobj();
				// });
